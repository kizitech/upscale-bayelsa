        ...
        <div className="flex grid-bg flex-col items-center justify-center relative z-20 px-4 w-full md:pt-20 h-full">
          ...
          <h1 className="md:text-7xl text-2xl text-center mt-4 font-semibold">
            <div className="flex gap-4 text-center justify-center items-center">
              ...
              <Link
                href="#services"
                className="bg-green-950 ease-in-out relative gap-4 hover:rounded-r-none duration-300 shrink-0 cursor-pointer text-sm rounded-lg md:h-10 md:w-10 h-8 w-8 m-0 font-semibold group flex items-center text-white justify-center overflow-visible"
              >
            ...
            <div className="flex items-center justify-center md:-mt-6 -mt-2 text-6xl md:text-[10rem]">
              ...
              <button
                ...
                className="bg-linear-90  relative cursor-pointer from-white to-90% to-green-950 flex items-center h-fit p-2 md:p-5 rounded-full md:w-48 w-24 md:mt-10 mt-5"
              >
                <div className="bg-white rounded-full relative md:p-6 p-2 w-full">
                  <div
                    className={`absolute -left-1 md:-top-2 -top-1.5  md:h-16 md:w-16 h-7 w-7 bg-white rounded-full border border-black/10 shadow-md shadow-black/20 duration-1000 ease-in-out ${isChecked ? "translate-x-0" : "md:translate-x-24 translate-x-15 rotate-180"}`}
                  ></div>
                </div>
              </button>
              wth
